...
CREATE TABLE `aluno_disciplina` (
  ...
  KEY `fk_id_disciplina_aluno` (`id_disciplina`),
  CONSTRAINT `fk_id_aluno_disciplina` FOREIGN KEY (`ra`) REFERENCES `aluno` (`ra`),
  CONSTRAINT `fk_id_disciplina_aluno` FOREIGN KEY (`id_disciplina`) REFERENCES `disciplina` (`id_disciplina`)
...
INSERT INTO `aluno_disciplina` VALUES (3,1),(6,1),(1,2),(2,3),(4,3),(5,4);
